...
if(isNaN(preco) || isNaN(irpf) || isNaN(pis) || isNaN(cofins) || isNaN(inss) || isNaN(issqn)) {
...
function gerarNota() {
  ...
  produtos.forEach((produto) => {
    ...
    const totalProduto = preco + Object.values(impostos).reduce((a, b) => a + b, 0);
  ...
  resumo.innerHTML = `
    ...
    <p><strong>Valor Total:</strong> R$ ${totalPreco.toFixed(2)}</p>
